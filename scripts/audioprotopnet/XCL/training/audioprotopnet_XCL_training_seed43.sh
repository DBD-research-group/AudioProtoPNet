#!/bin/bash
#SBATCH --job-name=audioprotopnet_XCL_seed43
#SBATCH --output=/mnt/data/rheinrich/DBD/audioprotopnet/job_logs/audioprotopnet_XCL_seed43_%j.log
#SBATCH --ntasks=1
